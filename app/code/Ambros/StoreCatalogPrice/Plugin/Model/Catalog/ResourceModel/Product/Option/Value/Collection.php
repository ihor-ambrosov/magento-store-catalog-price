...
namespace Ambros\StoreCatalogPrice\Plugin\Model\Catalog\ResourceModel\Product\Option\Value;

/**
 * Product option value collection plugin
 */
class Collection
{
     ...
     * 
     * @param \Magento\Catalog\Model\ResourceModel\Product\Option\Value\Collection $subject
    ...
    )
    {
        ...
        $defaultPriceTableAlias = 'default_value_price';
        ...
        $select->joinLeft(
            ...
            $this->connectionProvider->getCondition([
                $defaultPriceTableAlias.'.option_type_id = main_table.option_type_id',
        ...
        if (!$this->priceScope->isGlobal()) {
            $storePriceTableAlias = 'store_value_price';
            ...
            $select->joinLeft(
                ...
                $this->connectionProvider->getCondition([
                    $storePriceTableAlias.'.option_type_id = main_table.option_type_id',
